...
#SBATCH -p sysgen
#SBATCH --nodes=1
#SBATCH --job-name="SPAdes contigs 3.5.0 assembler comparison"
#SBATCH --ntasks=1
...
COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/spades_old1_contigs"
