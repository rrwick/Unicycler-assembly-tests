...
export JSA_CP="/vlsci/SG0006/rwick/japsa_v1.6-11c/lib/japsa:$JSA_CP"
...
COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/npscarf_from_graph"
