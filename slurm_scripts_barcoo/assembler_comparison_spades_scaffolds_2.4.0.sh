...
#SBATCH -p main
#SBATCH --nodes=1
#SBATCH --job-name="SPAdes scaffolds 2.4.0 assembler comparison"
#SBATCH --ntasks=1
...
COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/spades1_scaffolds"
