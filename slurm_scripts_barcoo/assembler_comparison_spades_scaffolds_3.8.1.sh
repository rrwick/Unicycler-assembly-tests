...
#SBATCH -p main
#SBATCH --nodes=1
#SBATCH --job-name="SPAdes scaffolds 3.8.1 assembler comparison"
#SBATCH --ntasks=1
...
export PATH="/vlsci/SG0006/rwick/SPAdes-3.8.1-Linux/bin:$PATH"
export PATH="/vlsci/SG0006/rwick/quast-4.4-barcoo:$PATH"
export PATH="/scratch/sysgen/rwick/Unicycler-assembly-tests:$PATH"

COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/spades4_scaffolds"
