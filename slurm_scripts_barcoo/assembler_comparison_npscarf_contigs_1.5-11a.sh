...
#SBATCH -p main
#SBATCH --nodes=1
#SBATCH --job-name="npScarf contigs v1.5-11a assembler comparison"
#SBATCH --ntasks=1
...
export PATH="/vlsci/SG0006/rwick/japsa_v1.5-11a/bin:$PATH"
...
COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/npscarf1_from_contigs"
