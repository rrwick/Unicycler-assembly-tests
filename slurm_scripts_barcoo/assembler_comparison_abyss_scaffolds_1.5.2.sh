...
#SBATCH -p main
#SBATCH --nodes=1
#SBATCH --job-name="ABySS scaffolds 1.5.2 assembler comparison"
#SBATCH --ntasks=1
...
COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/abyss1_64_scaffolds"
