...
#SBATCH -p main
#SBATCH --nodes=1
#SBATCH --job-name="ABySS scaffolds 2.0.2 assembler comparison"
#SBATCH --ntasks=1
...
export PATH="/vlsci/SG0006/rwick/abyss-2.0.2-barcoo/bin:$PATH"
export PATH="/vlsci/SG0006/rwick/quast-4.4-barcoo:$PATH"
export PATH="/scratch/sysgen/rwick/Unicycler-assembly-tests:$PATH"

COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/abyss2_64_scaffolds"
