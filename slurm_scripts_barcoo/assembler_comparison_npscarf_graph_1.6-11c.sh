...
#SBATCH -p main
#SBATCH --nodes=1
#SBATCH --job-name="npScarf graph v1.6-11c assembler comparison"
#SBATCH --ntasks=1
...
COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/npscarf3_from_graph"
