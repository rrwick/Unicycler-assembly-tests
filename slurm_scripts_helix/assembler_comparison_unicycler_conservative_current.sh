...
#SBATCH -p sysgen
#SBATCH --nodes=1
#SBATCH --job-name="Unicycler conservative current version assembler comparison"
#SBATCH --ntasks=1
...
COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/unicycler2_conservative"
