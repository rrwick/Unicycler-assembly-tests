...
#SBATCH -p sysgen
#SBATCH --nodes=1
#SBATCH --job-name="ABySS contigs 1.5.2 assembler comparison"
#SBATCH --ntasks=1
...
COMMAND_FILE="/scratch/sysgen/rwick/Unicycler-assembly-tests/assembly_commands/abyss1_64_contigs"
